...
namespace winrt::WindowsSample::implementation
{
    ...
    IFACEMETHODIMP VirtualCameraMediaSourceActivate::ActivateObject(REFIID riid, void** ppv)
    {
        ...
        *ppv = nullptr;
        ...
        {
            RETURN_IF_FAILED(m_spActivateAttributes->GetUINT32(VCAM_KIND, &vCamKind));
        }
        RETURN_HR_IF(ERROR_BAD_CONFIGURATION, vCamKind != static_cast<UINT32>(VirtualCameraKind::Synthetic));
        DEBUG_MSG(L"Activate OpenCamBridge SimpleMediaSource");
        ...
        return m_spSimpleMediaSrc->QueryInterface(riid, ppv);
    }
    ...
    {
        return MFCreateAttributes(&m_spActivateAttributes, 1);
    }
}
