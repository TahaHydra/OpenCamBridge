...
$cpp.Add("#pragma once")
$cpp.Add("#define OCBR_VERSION $($schema.version)")
$cpp.Add("#define OCBR_HEADER_SIZE $($schema.headerSize)")
$cpp.Add("#define OCBR_SLOT_HEADER_SIZE $($schema.slotHeaderSize)")
$cpp.Add("#define OCBR_SLOT_COUNT $($schema.slotCount)")
